...
class User{
    ...
    static var dummymemverList = [User(name: "나", content: "UI/UX 디자이너"),User(name: "dn", content: "UI/UX 디자이너"),User(name: "gg", content: "UI/UX 디자이너"),User(name: "as", content: "UI/UX 디자이너")]
}
