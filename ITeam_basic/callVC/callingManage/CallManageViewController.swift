...
class CallManageViewController: TabmanViewController, PageboyViewControllerDataSource, TMBarDataSource {
    ...
    override func viewDidLoad() {
        ...
        let CallAnswerVC = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "CallAnswerVC") as! CallAnswerViewController
        let CallRequestVC = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "CallRequestVC") as! CallRequestViewController
